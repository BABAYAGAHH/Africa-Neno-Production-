...
export default function ContactForm() {
  ...
  return (
    <div className="glass-panel p-6 sm:p-8">
      ...
      <h2 className="mt-3 font-display text-3xl text-white sm:text-4xl">Start the conversation</h2>
      <p className="mt-3 text-sm leading-7 text-white/62">
        Tell us about your session, event, or the premium imagery you want to create.
      </p>
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm leading-7 text-white/55">You can also contact the studio directly via WhatsApp for faster replies.</p>
